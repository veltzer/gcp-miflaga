# Cloud Run image for the miflaga Flask app, built by Cloud Build via
...
# The app resolves its files relative to the repo root, so preserve the
# src/ layout under /app.
COPY src/ src/
